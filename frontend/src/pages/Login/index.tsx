		...
		<div className="login-bg font-sans min-h-screen flex items-center justify-center p-4">
			<div className="w-sm max-w-md">
				<div className="flex items-center justify-center">
					<h1 className="text-3xl font-extrabold text-emerald-900 mb-8">RTKU Skillfit</h1>
				</div>
				...
				<p className="text-center text-emerald-800/40 text-xs mt-8 font-bold">&copy; 2026 RTKU SkillFit - All rights reserved.</p>
			</div>
		</div>
	);
};
